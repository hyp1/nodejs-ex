        ...
        io.of('/').on('connection', function(socket){
            socket.on('connection name',function(user){
             ...
             //   console.log(_user,'connected');
                ...
                _msg.setFrom({uid:this._user.uid,name:this._user._name});
